    ...
    def main(self):
        ...
        for (str1, str2, str3) in urls:
            ...
            for table in tables:
                data = at.Table.read(
                    str(table).replace(
                        '<table align="center" border="1" cellpadding="2" cellspacing="0" cols="6" width="100%">',
                        '<table align="center" border="1" cellpadding="2" cellspacing="0" cols="6" width="100%"><tr>',
                    ),
                    format="html",
                    names=("rowname", "rowval"),
                )
            ...
            if (nowdate - date_updated).days > self.options.max_decam_days:
                continue
            ...
            if lcr.status_code != 200:
                lcr = requests.get(
                    f"{lcurlbase}/{field}_cand{candid}.forced.difflc.txt"
                )
            ...
            photometrydict = {"instrument": "DECam", "obs_group": "YSE", "photdata": {}}
