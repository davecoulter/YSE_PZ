...
class SurveyFieldMSBViewSet(
    custom_viewsets.ListCreateRetrieveUpdateViewSet
...
class SurveyObsFilter(django_filters.FilterSet):
    ...
    mjd_requested_gte = django_filters.Filter(
        field_name="mjd_requested", lookup_expr="gte"
    )
    mjd_requested_lte = django_filters.Filter(
        field_name="mjd_requested", lookup_expr="lte"
    )
...
class TransientPhotometryViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_phot = PhotometryService.GetAuthorizedTransientPhotometry_ByUser(
            self.request.user
        )
        return allowed_phot
...
class HostPhotometryViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_phot = PhotometryService.GetAuthorizedHostPhotometry_ByUser(
            self.request.user
        )
        return allowed_phot
...
class TransientPhotDataViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_phot_data = PhotometryService.GetAuthorizedTransientPhotData_ByUser(
            self.request.user
        )
...
class HostPhotDataViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_phot_data = PhotometryService.GetAuthorizedHostPhotData_ByUser(
            self.request.user
        )
        return allowed_phot_data
...
class TransientSpectrumViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_spec = SpectraService.GetAuthorizedTransientSpectrum_ByUser(
            self.request.user
        )
        return allowed_spec
...
class HostSpectrumViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_spec = SpectraService.GetAuthorizedHostSpectrum_ByUser(
            self.request.user
        )
        return allowed_spec
...
class TransientSpecDataViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_spec_data = SpectraService.GetAuthorizedTransientSpecData_ByUser(
            self.request.user
        )
...
class HostSpecDataViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_spec_data = SpectraService.GetAuthorizedHostSpecData_ByUser(
            self.request.user
        )
        return allowed_spec_data
...
class ToOResourceViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_resource = ObservingResourceService.GetAuthorizedToOResource_ByUser(
            self.request.user
        )
...
class QueuedResourceViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_resource = ObservingResourceService.GetAuthorizedQueuedResource_ByUser(
            self.request.user
        )
        return allowed_resource
...
class ClassicalResourceViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_resource = ObservingResourceService.GetAuthorizedClassicalResource_ByUser(
            self.request.user
        )
        return allowed_resource
...
class ClassicalObservingDateViewSet(custom_viewsets.ListCreateRetrieveUpdateViewSet):
    ...
    def get_queryset(self):
        allowed_resource = ObservingResourceService.GetAuthorizedClassicalObservingDate_ByUser(
            self.request.user
        )
        return allowed_resource
...
class TransientFilter(django_filters.FilterSet):
    ...
    modified_date_gte = django_filters.DateTimeFilter(
        field_name="modified_date", lookup_expr="gte"
    )
    status_in = django_filters.BaseInFilter(
        field_name="status__name"
    )  # , lookup_expr='in')
