...
class HostSED(BaseModel):
    ...
    # Optional
    sed_type = models.ForeignKey(
        SEDType, null=True, blank=True, on_delete=models.SET_NULL
    )
...
class Host(BaseModel):
    ### Entity relationships ###
    # Optional
    host_morphology = models.ForeignKey(
        HostMorphology, null=True, blank=True, on_delete=models.SET_NULL
    )
    host_sed = models.ForeignKey(
        HostSED, null=True, blank=True, on_delete=models.SET_NULL
    )
    band_sextract = models.ForeignKey(
        PhotometricBand, null=True, blank=True, on_delete=models.SET_NULL
    )
    best_spec = models.ForeignKey(
        "HostSpectrum",
        related_name="+",
        null=True,
        blank=True,
