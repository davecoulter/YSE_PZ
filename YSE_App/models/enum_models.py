...
def get_sentinel_transientstatus():
    return TransientStatus.objects.get_or_create(
        name="StatusDeleted", created_by_id="1", modified_by_id="1"
    )[0]
...
def get_sentinel_followupstatus():
    return FollowupStatus.objects.get_or_create(
        name="StatusDeleted", created_by_id="1", modified_by_id="1"
    )[0]
...
def get_sentinel_taskstatus():
    return TaskStatus.objects.get_or_create(
        name="StatusDeleted", created_by_id="1", modified_by_id="1"
    )[0]
