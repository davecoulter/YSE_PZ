...
class TransientSerializer(serializers.HyperlinkedModelSerializer):
    status = serializers.HyperlinkedRelatedField(
        queryset=TransientStatus.objects.all(), view_name="transientstatus-detail"
    )
    obs_group = serializers.HyperlinkedRelatedField(
        queryset=ObservationGroup.objects.all(), view_name="observationgroup-detail"
    )

    non_detect_band = serializers.HyperlinkedRelatedField(
    ...
    best_spec_class = serializers.HyperlinkedRelatedField(
        queryset=TransientClass.objects.all(),
        allow_null=True,
        required=False,
        view_name="transientclass-detail",
        lookup_field="id",
    )
    photo_class = serializers.HyperlinkedRelatedField(
        queryset=TransientClass.objects.all(),
        allow_null=True,
        required=False,
        view_name="transientclass-detail",
    ...
    context_class = serializers.HyperlinkedRelatedField(
        queryset=TransientClass.objects.all(),
        allow_null=True,
        required=False,
        view_name="transientclass-detail",
    ...
    best_spectrum = serializers.HyperlinkedRelatedField(
    ...
    abs_mag_peak_band = serializers.HyperlinkedRelatedField(
        queryset=PhotometricBand.objects.all(),
        allow_null=True,
        required=False,
        view_name="photometricband-detail",
    ...
    antares_classification = serializers.HyperlinkedRelatedField(
        queryset=AntaresClassification.objects.all(),
        allow_null=True,
        required=False,
        view_name="antaresclassification-detail",
    )
    internal_survey = serializers.HyperlinkedRelatedField(
        queryset=InternalSurvey.objects.all(),
        allow_null=True,
        required=False,
        view_name="internalsurvey-detail",
    )
    tags = serializers.HyperlinkedRelatedField(
        queryset=TransientTag.objects.all(), many=True, view_name="transienttag-detail"
    )
    ...
    def update(self, instance, validated_data):
        ...
        instance.non_detect_band = validated_data.get(
            "non_detect_band", instance.non_detect_band
        )
        instance.best_spec_class = validated_data.get(
            "best_spec_class", instance.best_spec_class
        )
        instance.photo_class = validated_data.get("photo_class", instance.photo_class)
        instance.best_spectrum = validated_data.get(
            "best_spectrum", instance.best_spectrum
        )
        instance.host = validated_data.get("host", instance.host)
        instance.abs_mag_peak_band = validated_data.get(
            "abs_mag_peak_band", instance.abs_mag_peak_band
        )
        instance.created_by = validated_data.get("created_by", instance.created_by)
        instance.modified_by = validated_data.get(
            "modified_by_id", instance.modified_by
        )
        instance.antares_classification = validated_data.get(
            "antares_classification", instance.antares_classification
        )
        instance.internal_survey = validated_data.get(
            "internal_survey", instance.internal_survey
        )
        ...
        instance.candidate_hosts = validated_data.get(
            "candidate_hosts", instance.candidate_hosts
        )
        ...
        instance.redshift_source = validated_data.get(
            "redshift_source", instance.redshift_source
        )
        instance.non_detect_date = validated_data.get(
            "non_detect_date", instance.non_detect_date
        )
        instance.non_detect_limit = validated_data.get(
            "non_detect_limit", instance.non_detect_limit
        )

        instance.mw_ebv = validated_data.get("mw_ebv", instance.mw_ebv)
        instance.abs_mag_peak = validated_data.get(
            "abs_mag_peak", instance.abs_mag_peak
        )
        instance.abs_mag_peak_date = validated_data.get(
            "abs_mag_peak_date", instance.abs_mag_peak_date
        )
        instance.postage_stamp_file = validated_data.get(
            "postage_stamp_file", instance.postage_stamp_file
        )
        instance.k2_validated = validated_data.get(
            "k2_validated", instance.k2_validated
        )
        instance.k2_msg = validated_data.get("k2_msg", instance.k2_msg)
        instance.TNS_spec_class = validated_data.get(
            "TNS_spec_class", instance.TNS_spec_class
        )
