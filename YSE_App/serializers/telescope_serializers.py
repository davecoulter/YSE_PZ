...
class TelescopeSerializer(serializers.HyperlinkedModelSerializer):
    observatory = serializers.HyperlinkedRelatedField(
        queryset=Observatory.objects.all(), view_name="observatory-detail"
    )
    ...
    def update(self, instance, validated_data):
        instance.observatory_id = validated_data.get(
